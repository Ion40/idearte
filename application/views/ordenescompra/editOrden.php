									...
									<div class="card card-flush overflow-hidden h-md-100">
										...
										<div class="card-header py-5">
											...
											<h3 class="card-title align-items-start flex-column">
												<span class="card-label fw-bolder text-dark">Editar Orden de compra</span>
												  ...
												  <div class="row g-12 mb-8">
                                                        <div class="col-md-4 fv-row">
															...
															<div class="input-group mb-5">
                                                                ...
                                                                <input type="hidden" value="<?= $this->uri->segment(2); ?>" class="form-control" readonly id="idorden" />
                                                                <input type="hidden" value="<?= $this->session->userdata("idArea"); ?>" class="form-control" readonly id="idarea" />
																<input value="<?= $this->session->userdata("Area"); ?>" class="form-control" readonly id="area" />
															</div>
															<!--end::Input-->
														</div>
														<div class="col-md-3 fv-row">
															<label for="fechaSol" class="form-label required">Fecha Solicitud</label>
															<div class="input-group mb-5">
																<span class="input-group-text" id="basic-addon1">
																	<!--begin::Svg Icon | path: icons/duotune/communication/com006.svg-->
																	<span class="svg-icon svg-icon-3">
																...
																<input class="form-control" value="<?= date("d-m-Y")?>" readonly id="fechaSol" />
															</div>
															<!--end::Input-->
														</div>
													</div>
													...
													<!--<div class="d-flex flex-column mb-7 fv-row">
														<label for="descSol" class="form-label required">Descripción de la solicitud</label>
														<div class="input-group">
                                                            ...
                                                            <textarea id="descSol" class="form-control" aria-label="With textarea" style="height: 97px;"></textarea>
                                                        </div>
													</div>-->
                                                    <div class="row g-12 mb-8">
                                                      <div class="col-md-3 fv-row">
															<label for="cantidad" class="form-label required">Artículo</label>
															<div class="input-group mb-5">
																<span class="input-group-text" id="basic-addon1">
																	<!--begin::Svg Icon | path: icons/duotune/communication/com006.svg-->
																	<span class="svg-icon svg-icon-3">
																...
																<input type="text" id="articulo" class="form-control" aria-label="articulo"
														...
														<div class="col-md-2 fv-row">
															<label for="cantaut" class="form-label required">Cantidad Solicitada</label>
															<div class="input-group mb-5">
																<span class="input-group-text" id="basic-addon1">
																	<!--begin::Svg Icon | path: icons/duotune/communication/com006.svg-->
																	<span class="svg-icon svg-icon-3">
														...
														<div class="col-md-2 fv-row">
                                                            <div class="text-left">
                                                            <button id="btnAddArt" class="btn btn-icon btn-block btn-success me-3 btn-hover-rise me-5" data-bs-toggle="tooltip" title="Agregar artículo">
                                                                ...
                                                                <button id="btnDelete" class="btn btn-icon btn-danger btn-hover-rise me-5" data-bs-toggle="tooltip" title="Eliminar artículo"><span class="svg-icon svg-icon-1">
                                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
													...
													<div class="row g-12 mb-8">
														<div class="col-md-10 fv-row">
                                                            <label for="descArt" class="form-label required">Descripción del artículo</label>
                                                            <div class="input-group">
                                                                <span class="input-group-text">
                                                                <span class="svg-icon svg-icon-3">
                                                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                                ...
                                                                <textarea id="descArt" class="form-control" aria-label="With textarea" style="height: 97px;"></textarea>
                                                            </div>
														</div>
														<!--end::Col-->
													</div>
                                                    <div class="row g-12 mb-8">
														<div class="col-md-12 fv-row border border-primary p-7 rounded mb-7">
                                                            <table id="tblArticulos" class="table table-striped table-row-bordered table-responsive gy-5 gs-7">
													...
													<button class="btn btn-primary me-3" id="btnSaveSolic">
														<i class="fa fa-save"></i>Actualizar Solicitud
													</button>
													<a class="btn btn-danger" href="<?= base_url("index.php/Ordencompra")?>">
