    ...
    $.bindViewer = function (elm) {
        ...
        function viewImg() {
            var $obj = $(this),
                ...
                $img = $("<img style='position:fixed;z-index:9999998;left:436px;border-radius:8px;' src='" + src + "' />"),
                //$bg = $("<div style='position:fixed;z-index:9999997;top:0;left:0;width:100%;height:" + doc_h + "px;background:black;opacity:0.6;'></div>"),
                $bg = $("<div style='position: fixed;z-index: 9999997;top: 92px;left: 436px;width: 50%;height: 729.33px;background: black;opacity: 0.6;'></div>"),
                $close = $("<a title='Cerrar' style='position:fixed;z-index:9999999;left:35%;padding:11px 15px;cursor:pointer;background:black;color:white;border-radius:50%;font-family:Arial;font-size:14px;transition:background .5s;text-decoration:none; display:block !important;'>X</a>");
